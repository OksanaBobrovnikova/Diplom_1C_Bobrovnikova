...
*Я проверяю полученный Результат
	...
	| 'ООО Айсберг'        |                                   | '4 000,00'          | ''                         |
	| ''                   | 'Абонентский дог. №5/25'          | '4 000,00'          | ''                         | 
	| 'ООО Белый слон'     | ''                                | '4 500,00'          | ''                         | 
	| ''                   | 'Абонентский дог. №4/25'          | '4 500,00'          | ''                         | 
	| 'ООО Лес'            | ''                                | '4 000,00'          | ''                         | 
	| ''                   | 'Абонентский дог. №2/25'          | '4 000,00'          | ''                         | 
	| 'ООО Путник'         | ''                                | '12 000,00'         | ''                         | 
	| ''                   | 'Абонентский дог. №1/25'          | '12 000,00'         | ''                         | 
	| 'Итого'              | ''                                | '24 500,00'         | ''                         |
